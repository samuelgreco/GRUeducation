...
<head>
	...
	<table style="width: 100%;text-align:center;">
		...
		<tr>
			<td><i>Lista de Inscrições INDEFERIDAS</i></td>
		</tr>
	</table><br />
	<center>
<?php
	...
	function listaInscricoes(){
		...
		$db ['sql'] = 	"SELECT DISTINCT AI.CPF, AI.IDINSCRICAO, 
						...
						AC.CATEGORIA,AI.STATUS, CASE WHEN AI.STATUS=4 THEN AJ.JUSTIFICATIVA ELSE 'Não Entregou o Trabalho' END AS JUSTIFICATIVA
						...
						ON AI.IDINSCRICAO=AJ.IDINSCRICAO
						WHERE AI.STATUS IN (4,1)
