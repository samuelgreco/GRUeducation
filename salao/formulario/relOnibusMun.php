...
<head>
	...
	<script type="text/javascript" src="../js/relOnibusMun.js"></script>

</head>
<!--  <a href='javascript:history.back(2)' class='Voltar' >Voltar</a> -->
<body>
<h1>Relat&oacute;rio de vagas em &ocirc;nibus municipais</h1>
<form id="frmOnibusMun" name="frmOnibusMun" method="post" action="relListaOnibusMun.php">
<table>
	<tr>
		<td>Dia: *<br />
